...
[AddComponentMenu("uScript/Graphs/car_movement")]
public class car_movement_Component : uScriptCode
{
   #pragma warning disable 414
   public car_movement ExposedVariables = new car_movement( ); 
      ...
      {
         {
            ...
            gameObject = GameObject.Find( "car1" ); 
